...
public class MainActivity extends Activity {
	...
	public void scheduleTT() {
		...
		t.scheduleAtFixedRate(new TimerTask() {
			...
			public void run() {
				...
				// period parameter)
				// We must use this function in order to change the text view
				// text
				runOnUiThread(new Runnable() {
					...
					public void run() {
						...
						/*
						 * CuttingBoard.incY -= Vx; CuttingBoard.incX += Vy; //+
						 * 1*ti;
						 */
						...
						// Log.v(Integer.toString(CuttingBoard.incX),
						// Integer.toString(CuttingBoard.incY));
	 ...
	 * switch (requestCode) { case (STATIC_INTEGER_VALUE): { if (resultCode ==
	 * Activity.RESULT_OK) { String newText = data
	 * .getStringExtra(PUBLIC_STATIC_STRING_IDENTIFIER); // TODO Update your
	 * TextView. } break; } } }
	 */
}
